...
def get_tmy(lati, long):
    ...
    for hour, directions in hourly_wind_data.items():
        ...
        mean_direction = mean_direction if mean_direction >= 0 else mean_direction + 360
...
def plot_mean_wd_per_hour(wd_list):
    ...
    plt.grid(True)
    plt.text(0, -20, "Χρήστος Μπιγδέλης, 151930")
    # Saving the plot as a JPEG file
    # plt.savefig(f'C:\\dewp2023{151930}_graph3.jpeg')
